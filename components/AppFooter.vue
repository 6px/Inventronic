<template>
  <nav class="dark:bg-slate-300 bg-slate-800 p-4 mt-8">
    <UContainer>
      <div class="flex justify-between items-center">
        ...
        <div class="flex justify-end">
          ...
          <UButton target="_blank" class="p-0 border-0 mx-4" variant="link" color="white" to="https://hub.docker.com/repository/docker/jonathanfoucher/inventronic/">
            <img src="/docker.png" width="32" height="32" />
          </UButton>
          <UButton target="_blank" class="p-0 border-0 mx-4" variant="link" color="white" to="https://supabase.com">
            <img src="/supabase-logo-icon.png" width="32" height="32" />
          </UButton>
        </div>
      </div>
    </UContainer>
