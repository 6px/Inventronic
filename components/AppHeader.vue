    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex flex-shrink-0 items-center">
          <NuxtLink
              to="/"
              class="text-primary-600 pr-3 py-2 flex items-center"
            >
              <UIcon name="i-heroicons-outline-bolt" />
              INVENTRONIC
            </NuxtLink>
        </div>
...
<!-- <div>
    ...
    <div class="flex items-center justify-between">
      <div class="block md:hidden">
        <UButton @click="showNav=!showNav" class="ml-4">
          ...
        </UButton>
      </div>
      <div :class="`${showNav ? 'flex flex-col shrink' : 'hidden' } md:block`">
        <UButton
          label="INVENTRONIC"
          variant="link"
          to="/"
